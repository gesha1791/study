...
public class FileInputStreamDemo {
    public static void main(String[] args) {
        ...
        try(FileInputStream f =
                    new FileInputStream("C:\\torrent\\Хватит быть славным парнем!.torrent")) {
            size = f.available();
            ...
            System.out.println("Все еще доступно: " + size);

            System.out.println("Пропустить половину оставшихся методом skip");
            f.skip(size/2);
